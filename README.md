...
**📞 Mobile:** 678-637-4861 | **📧 Email:** [Nimesh75@gmail.com](mailto:Nimesh75@gmail.com) | **🐱 GitHub:** [github.com/Nimesh-Patel](https://github.com/Nimesh-Patel)
...
- Innovator in **DevOps Architecture**, implementing self-hosted GitHub runners, Azure Batch automation, and containerized workflows (Docker/Podman) to accelerate model deployment by **40%**.
...
#### **Computer Scientist / Data Scientist (GS-1550-14-07)** – CDC/CFA  
**Sep. 2022 – Present**
...
- Implemented self-hosted GitHub runners for **CI/CD**, enabling automated job submissions from GitHub to Azure Batch.
...
### **Data Scientist (GS-1550-13-10)**- CDC/NCIPC     
**Jan. 2020 – Sep. 2022**
...
### **Acting Team Lead (GS-2210-13-10)** - CDC/NCIPC     
**Jan. 2019 – Jan. 2020**
...
### **Lead IT Specialist (GS-2210-13-10)** - CDC/NCIPC     
**Jan. 2008 – Dec. 2019**
...
### **Lead Computer Programmer, BioSense Surveillance** – CDC/NCPHI     
**Apr. 2007 – Jan. 2008**
...
### **Wayne State Univ./Karmanos Cancer Inst.**, Detroit, MI     
**Dec. 2000 – July 2004**
...
1. **GitHub Runners & Azure DevOps**
   - Automated ML job submissions from GitHub to Azure Batch via self-hosted runners, streamlining the deployment process and enhancing efficiency.

2. **CDCgov/cfa_azure Python Module**
   - Developed a unified Azure Python module for container lifecycle management, simplifying operations and improving resource utilization.
